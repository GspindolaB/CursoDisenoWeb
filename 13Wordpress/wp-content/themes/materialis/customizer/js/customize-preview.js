...
(function ($) {
  ...
  wp.customize('header_nav_border', function (value) {
    value.bind(function (newval) {
      if (newval) {
        parent.CP_Customizer.contentStyle.setProp(
          '.materialis-front-page .navigation-bar.bordered:not(.fixto-fixed)',
          null,
          'border-bottom-width',
          wp.customize('header_nav_border_thickness').get() + 'px'
        );
        parent.CP_Customizer.contentStyle.setProp(
          '.materialis-front-page .navigation-bar.bordered',
          null,
          'border-bottom-color',
          wp.customize('header_nav_border_color').get()
        );
      }
    });
  });
  wp.customize('inner_header_nav_border', function (value) {
    value.bind(function (newval) {
      if (newval) {
        parent.CP_Customizer.contentStyle.setProp(
          '.materialis-inner-page .navigation-bar.bordered:not(.fixto-fixed)',
          null,
          'border-bottom-width',
          wp.customize('inner_header_nav_border_thickness').get() + 'px'
        );
        parent.CP_Customizer.contentStyle.setProp(
          '.materialis-inner-page .navigation-bar.bordered',
          null,
          'border-bottom-color',
          wp.customize('inner_header_nav_border_color').get()
        );
      }
    });
  });
...
(function ($) {
    ...
    wp.customize('layout_boxed_content_overlap_height', function (value) {
        value.bind(function (value) {
            var $elements = $('body #page .page-content,body #page > .content ');
            $elements.css({'margin-top': '-' + value + 'px'});
        });
    });
