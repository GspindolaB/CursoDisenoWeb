...
{
    $class = is_active_sidebar('sidebar-1') ? 'col-sm-8' : 'col-sm-12';
...
function materialis_print_pagination($args = array(), $class = 'pagination')
{
    ...
    <div class="navigation %1$s" role="navigation">
        ...
        <div class="nav-links mdc-elevation--z5"><div class="prev-navigation">%3$s</div><div class="numbers-navigation">%4$s</div><div class="next-navigation">%5$s</div></div>
    </div>', $args, $class);
...
function materialis_print_about_widget()
{
    ...
    if (materialis_get_theme_mod("show_author_about_box", true)):
        ?>
